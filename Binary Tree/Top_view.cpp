...
class Solution
{
   ...
   vector<int> topView(Node *root) {
    ...
    // Map to store the top view nodes (key: horizontal distance, value: node's data)
    map<int, int> topNode;
    ...
    while (!q.empty()) {
        ...
        // Maintain 1:1 mapping; if the horizontal distance is not already present, add it
